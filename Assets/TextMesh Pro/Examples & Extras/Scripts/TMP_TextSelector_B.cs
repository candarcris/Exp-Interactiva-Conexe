...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // Restore UV0S
            // UVS0
            Vector4[] src_uv0s_4 = m_cachedMeshInfoVertexData[materialIndex].uvs0;
            Vector4[] dst_uv0s_4 = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0;

            Vector2[] src_uv0s = src_uv0s_4.Select(v => new Vector2(v.x, v.y)).ToArray();
            Vector2[] dst_uv0s = dst_uv0s_4.Select(v => new Vector2(v.x, v.y)).ToArray();
            ...
            // UVS0
            src_uv0s = m_cachedMeshInfoVertexData[materialIndex].uvs0.Select(v => new Vector2(v.x, v.y)).ToArray();
            dst_uv0s = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0.Select(v => new Vector2(v.x, v.y)).ToArray();
