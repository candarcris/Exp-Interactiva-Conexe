        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    Vector4[] sourceUVs0_4 = cachedMeshInfoVertexData[materialIndex].uvs0;
                    Vector4[] destinationUVs0_4 = textInfo.meshInfo[materialIndex].uvs0;

                    Vector2[] sourceUVs0 = sourceUVs0_4.Select(v => new Vector2(v.x, v.y)).ToArray();
                    Vector2[] destinationUVs0 = destinationUVs0_4.Select(v => new Vector2(v.x, v.y)).ToArray();
